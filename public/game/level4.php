...
<form id="level4" action="game.php" method="post" class="container-fluid  d-flex flex-column align-items-center justify-content-center vh-100">
    <h2>Level 4: Arrange these 6 numbers in Descending order</h2>
